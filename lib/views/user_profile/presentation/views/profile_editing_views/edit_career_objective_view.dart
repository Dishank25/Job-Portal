...
class Editcareer_objectiveView extends StatefulWidget {
  final String career_objective;

  const Editcareer_objectiveView({super.key, required this.career_objective});

  @override
  State<Editcareer_objectiveView> createState() =>
      _Editcareer_objectiveviewstate();
}

class _Editcareer_objectiveviewstate extends State<Editcareer_objectiveView> {
