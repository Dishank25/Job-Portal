...
class UserDetailModel extends UserDetailEntity {
  UserDetailModel({
    ...
    required super.isphone_verified,
    required super.is_gst_verified,
    super.userprofile_pic,
  ...
  factory UserDetailModel.fromJson(Map<String, dynamic> json) {
    ...
    return UserDetailModel(
      ...
      isphone_verified: user['isphone_verified'],
      is_gst_verified: user['is_gst_verified'],
      userprofile_pic: user['userprofile_pic'],
