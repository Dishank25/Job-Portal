...
class FeedRepositoryImpl extends FeedRepository {
  ...
  Future<DataState<FeedPostLikeEntity>> feedPostLike(
      String feedpost_id, Map<String, dynamic> params) async {
    try {
      final response = await _apiService.feedPostLike(feedpost_id, params);
  ...
  Future<DataState<FeedPostCommentEntity>> feedPostComment(
      String feedpost_id, Map<String, dynamic> params) async {
    try {
      final response = await _apiService.feedPostComment(feedpost_id, params);
