...
class YearPickerField extends StatelessWidget {
  ...
  Future<void> _showYearPickerDialog(BuildContext context) async {
    ...
    final List<int> years =
        List.generate(30, (index) => currentYear - 15 + index);
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return ListTile(
                      ...
                      onTap: () {
                        controller.text = years[index].toString();
      ...
      child: IgnorePointer(
        child: TextFormField(
          ...
          decoration: InputDecoration(
            ...
            suffixIcon:
                Icon(suffixIcon, color: suffixIconColor ?? Colors.grey[600]),
            border: OutlineInputBorder(
              borderRadius: BorderRadius.circular(borderRadius!),
              borderSide:
                  BorderSide(color: borderColor ?? Colors.grey[400]!, width: 1),
            ),
            enabledBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(borderRadius!),
              borderSide:
